...
# Mount cloud storage
alias s3fsmount="s3fs -o url=https://storage.googleapis.com -o passwd_file=.passwd-s3fs -o nomultipart -o sigv2 -o umask=0002,mp_umask=0002,uid=1000,gid=1000,allow_other -o use_cache=$STEWARD_CACHE"
