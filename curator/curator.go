// Curator Go program providing a Git HTTP backend
// 
// Based on https://github.com/asim/git-http-backend with minor configration edits
//
// Previously found that this did not gracefully shutdown (see https://godoc.org/github.com/zenazn/goji/graceful
// for a possible solution to that). Does not seem to be a problem now (July 2015).
...
var config Config = Config{
	ProjectRoot: "/srv/stencila/store/",
...
func main() {
	...
	err := http.ListenAndServe(":7311", nil)
	if err != nil {
