# Generated by Django 3.0.7 on 2020-07-06 09:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projects_total', models.IntegerField(default=100, help_text='The maximum number of projects that an account can have.', verbose_name='Projects')),
                ...
                ('storage_working', models.IntegerField(default=1, help_text='The maximum number of gigbytes of storage in project working directories.', verbose_name='Working storage')),
                ('storage_snapshots', models.IntegerField(default=5, help_text='The maximum number of gigbytes of storage in project snapshots.', verbose_name='Snapshot storage')),
            ],
        ),
        migrations.CreateModel(
            name='AccountUser',
