...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('account', 'user'), name='account_user_unique_user'),
        ),
        migrations.AddConstraint(
            model_name='accountteam',
            constraint=models.UniqueConstraint(fields=('account', 'name'), name='account_team_unique_name'),
        ),
    ]
