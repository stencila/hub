    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage_working', models.FloatField(default=1, help_text='The maximum storage in project working directories (GB).', verbose_name='Working storage')),
                ('storage_snapshots', models.FloatField(default=5, help_text='The maximum storage in project snapshots (GB).', verbose_name='Snapshot storage')),
                ('job_runtime_month', models.FloatField(default=1000, help_text='The maximum number of job minutes per month.', verbose_name='Job minutes')),
            ],
        ),
        migrations.CreateModel(
            name='AccountUser',
