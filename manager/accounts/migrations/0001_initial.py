# Generated by Django 3.0.6 on 2020-06-04 03:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.SlugField(help_text="Name of the account.", unique=True),
                ),
                (
                    "image",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="A space separated list of valid hosts for the account. Used for setting Content Security Policy headers when serving content for this account.",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.TextField(help_text="Name of the team.")),
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Team description.", null=True
                    ),
                ),
                (
                    "account",
                ...
                (
                    ...
                    models.ManyToManyField(
                        help_text="Team members.", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
        ),
