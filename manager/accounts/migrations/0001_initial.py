# Generated by Django 3.0.6 on 2020-06-06 10:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.SlugField(help_text='Name of the account. Lowercase only. Will be used in URLS e.g. https://hub.stenci.la/awesome-org', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('MEMBER', 'Member'), ('MANAGER', 'Manager'), ('ADMIN', 'Admin')], help_text='Role the user has within the account.', max_length=32)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('account', 'user'), name='unique_user'),
        ),
    ]
