# Generated by Django 3.0.6 on 2020-06-09 08:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public', models.BooleanField(default=False, help_text='Should the project be publicly visible?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('READER', 'Reader'), ('COMMENTER', 'Commenter'), ('SUGGESTER', 'Suggester'), ('AUTHOR', 'Author'), ('OWNER', 'Owner')], help_text='Role the user or team has within the project.', max_length=32)),
                ...
                ('team', models.ForeignKey(help_text='A team given access to the project.', on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='accounts.AccountTeam')),
                ('user', models.ForeignKey(help_text='A user given access to the project.', on_delete=django.db.models.deletion.CASCADE, related_name='projects', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddConstraint(
            model_name='projectagent',
            constraint=models.UniqueConstraint(fields=('project', 'user', 'team'), name='unique_agent'),
        ),
        migrations.AddConstraint(
            model_name='project',
