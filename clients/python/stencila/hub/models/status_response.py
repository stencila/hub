...
class StatusResponse(object):
    ...
    def __init__(self, time=None, version=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def time(self):
        """Gets the time of this StatusResponse.  # noqa: E501

        The current time in ISO format  # noqa: E501

        :return: The time of this StatusResponse.  # noqa: E501
        :rtype: str
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this StatusResponse.

        The current time in ISO format  # noqa: E501

        :param time: The time of this StatusResponse.  # noqa: E501
        :type time: str
        """
        if self.local_vars_configuration.client_side_validation and time is None:  # noqa: E501
            raise ValueError("Invalid value for `time`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                time is not None and len(time) < 1):
    ...
    @property
    def version(self):
        """Gets the version of this StatusResponse.  # noqa: E501

        The current version  # noqa: E501

        :return: The version of this StatusResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        ...
        :param version: The version of this StatusResponse.  # noqa: E501
        :type version: str
        """
