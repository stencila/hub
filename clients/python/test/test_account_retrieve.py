...
import stencila.hub
from stencila.hub.models.account_retrieve import AccountRetrieve  # noqa: E501
from stencila.hub.rest import ApiException

class TestAccountRetrieve(unittest.TestCase):
    """AccountRetrieve unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AccountRetrieve
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = stencila.hub.models.account_retrieve.AccountRetrieve()  # noqa: E501
        if include_optional :
            return AccountRetrieve(
                ...
                role = '0', 
                users = [
                    stencila.hub.models.account_user.AccountUser(
                        id = 56, 
                        user = stencila.hub.models.user.User(
                            id = 56, 
                            username = 'a', 
                            first_name = '0', 
                            last_name = '0', ), 
                ...
                teams = [
                    stencila.hub.models.account_team.AccountTeam(
                        id = 56, 
                        account = 56, 
                        name = '0', 
                        description = '0', 
                        members = [
                            stencila.hub.models.user.User(
                                id = 56, 
                                username = 'a', 
                                first_name = '0', 
                                last_name = '0', )
