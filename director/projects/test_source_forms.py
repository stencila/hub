...
class TestGithubSourceForm(TestCase):
    ...
    def test_valid_github_http_url(self):
        ...
        """
        f = GithubSourceForm(self._get_form_data(repo='http://github.com/myname/therepo'))
        self.assertTrue(f.is_valid())
    ...
    def test_valid_github_http_url_trailing_slash(self):
        ...
        """
        f = GithubSourceForm(self._get_form_data(repo='http://github.com/some-username/the-3repo/'))
        self.assertTrue(f.is_valid())
    ...
    def test_valid_github_https_url(self):
        ...
        """
        f = GithubSourceForm(self._get_form_data(repo='https://github.com/other-username/the-4repo'))
        self.assertTrue(f.is_valid())
    ...
    def test_valid_github_https_url_trailing_slash(self):
        ...
        """
        f = GithubSourceForm(self._get_form_data(repo='https://github.com/valid-6/the-5repo/'))
        self.assertTrue(f.is_valid())
    ...
    def test_valid_github_url_no_scheme(self):
        ...
        f = GithubSourceForm(self._get_form_data(repo='github.com/reallygood/someproject'))
        self.assertTrue(f.is_valid())
    ...
    def test_invalid_github_repo_bad_characters(self):
        ...
        """
        f = GithubSourceForm(self._get_form_data(repo='http://github.com/my$name/ther&epo'))
    ...
    def test_invalid_github_repo_too_many_components(self):
        ...
        """
        f = GithubSourceForm(self._get_form_data(repo='https://github.com/valid-8/the-8repo/anothercomponent'))
        self.assertFalse(f.is_valid())
    ...
    def test_invalid_github_repo_wrong_scheme(self):
        ...
        """
        f = GithubSourceForm(self._get_form_data(repo='ftp://github.com/valid-8/the-8repo'))
        self.assertFalse(f.is_valid())
    ...
    def test_invalid_github_repo_wrong_host(self):
        ...
        """
        f = GithubSourceForm(self._get_form_data(repo='https://notgithub.com/valid-8/the-8repo'))
        self.assertFalse(f.is_valid())
