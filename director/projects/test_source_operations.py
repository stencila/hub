...
class DetermineEntryTypeTest(TestCase):
    ...
    def test_determine_file(self):
        ...
        self.assertEqual(DirectoryEntryType.FILE, determine_entry_type(FileSource(), 'name'))
    ...
    def test_determine_directory(self):
        ...
        self.assertEqual(DirectoryEntryType.DIRECTORY, determine_entry_type(FileSource(), 'long/path'))

    def test_determine_linked(self):
        """An entry should be considered a linked source if its source is not FileSource."""
        self.assertEqual(DirectoryEntryType.LINKED_SOURCE, determine_entry_type(GithubSource(), 'long/path'))
        self.assertEqual(DirectoryEntryType.LINKED_SOURCE, determine_entry_type(GithubSource(), 'name'))
...
class SourcesInDirectoryTest(TestCase):
    ...
    @mock.patch('projects.source_operations.iterate_github_source', side_effect=mock_ghs_iterator)
...
class DirectoryListingTest(TestCase):
    ...
    def test_sorting(self):
        ...
        self.assertEqual([DirectoryEntryType.DIRECTORY, DirectoryEntryType.DIRECTORY, DirectoryEntryType.LINKED_SOURCE,
