...
class ProjectHostSessionsViewTests(TestCase):
    ...
    def test_create_session(self):
        ...
        session_url = self.view.create_session(self.request, self.environ, session_key, session_request_to_use)
    ...
    def test_generate_response_existing_session_url(self, mock_json_response_class):
        ...
        response = self.view.generate_response(self.request, self.environ, 'session_key', self.token, session_url)
