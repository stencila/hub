...
class ProjectPermissionTests(TestCase):
    def test_get_highest_permissions(self):
        ...
        self.assertIsNone(get_highest_permission([]))  # return None if no permissions passed in

        self.assertEqual(ProjectPermissionType.OWN,
                         get_highest_permission(
                             [ProjectPermissionType.EDIT, ProjectPermissionType.MANAGE, ProjectPermissionType.OWN]))

        self.assertEqual(ProjectPermissionType.MANAGE,
                         get_highest_permission(
                             [ProjectPermissionType.VIEW, ProjectPermissionType.EDIT, ProjectPermissionType.MANAGE]))

        self.assertEqual(ProjectPermissionType.VIEW, get_highest_permission([ProjectPermissionType.VIEW]))
    ...
    def test_permission_comparison(self):
        ...
        """
        self.assertEqual(ProjectPermissionType.VIEW, ProjectPermissionType.VIEW)  # Make sure equality wasn't broken
