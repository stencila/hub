...
from stencila_open.views import OpenView, OpenDisplayView, OpenResultRawView, OpenFeedbackView, OpenMediaView, \
    OpenPreviewView, OpenManifestView
...
urlpatterns = [
    ...
    path('<slug:conversion_id>/preview', OpenPreviewView.as_view(), name='open_preview'),
    ...
    path('<slug:conversion_id>/manifest', OpenManifestView.as_view(), name='open_manifest'),
]
