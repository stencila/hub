...
CONFIRMATION_PHRASE = "testenvironmentonly"  # extra step to prevent this being run inadvertently
...
def run(*args):
    if len(args) != 1 or args[0] != CONFIRMATION_PHRASE:
        raise ValueError("This script must be run with the correct confirmation phrase.")
