...
urlpatterns = [
    ...
    path(AccountUrlRoot.members.value + '/', accounts_views.AccountAccessView.as_view(), name='account_access'),
    ...
    path(AccountUrlRoot.subscriptions.value + '/add/<int:plan_pk>/',
         subscription_views.AccountSubscriptionAddView.as_view(), name='account_subscriptions_add'),
    path(AccountUrlRoot.subscriptions.value + '/<str:subscription_id>/',
         subscription_views.SubscriptionDetailView.as_view(), name='account_subscription_detail'),
