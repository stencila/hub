...
def features(request: HttpRequest) -> typing.Dict[str, bool]:
    """Feature toggle variables."""
    return {"FEATURE_{}".format(k): v for k, v in conf.settings.FEATURES.items()}
